...
var sqlRowField = []string{
	rowNumConstStr, dataSourceConstStr, sqlConstStr, executeCountConstStr,
...
var sqlColField = []string{
	"ID", "DataSource", "SQL", "ExecuteCount",
...
var dsRowField = []string{
	rowNumConstStr, urlConstStr, activeConnCountConstStr,
...
var dsColField = []string{
	"ID", "ConnCount", "ActiveConnCount",
