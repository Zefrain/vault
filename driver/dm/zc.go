...
var (
	dmDriverIDGenerator  = new(IDGenerator)
	dmConntorIDGenerator = new(IDGenerator)
	dmConnIDGenerator    = new(IDGenerator)
	dmStmtIDGenerator    = new(IDGenerator)
	dmResultIDGenerator  = new(IDGenerator)
	dmRowsIDGenerator    = new(IDGenerator)
)
